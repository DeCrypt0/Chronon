...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000002f1385b6905cf284cc875db7f1ef158e97db816c7b8095f7eb2034c5c73"));
;
...
public:
	...
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        vSeeds.push_back(CDNSSeedData("seed1.chronon.info", "seed1.chronon.info"));
        vSeeds.push_back(CDNSSeedData("seed2.chronon.info", "seed2.chronon.info"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
