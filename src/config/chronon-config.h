/* src/config/chronon-config.h.  Generated from chronon-config.h.in by configure.  */
/* src/config/chronon-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://chronon.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Chronon Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Chronon Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "chronon"
