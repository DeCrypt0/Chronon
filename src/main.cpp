...
#if defined(NDEBUG)
#error "Chronon cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Chronon Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 3300 ) {
	        nSubsidy = 1 * COIN;
	}else if( nHeight > 3300 && nHeight <= 8400 ) {
	        nSubsidy = 5 * COIN;
	}else if( nHeight > 8400 && nHeight <= 12600 ) {
	        nSubsidy = 10 * COIN;
	}else if( nHeight > 12600 && nHeight <= 20300 ) {
	        nSubsidy = 20 * COIN;
	}else if( nHeight > 20300 && nHeight <= 24800 ) {
	        nSubsidy = 35 * COIN;
	}else if( nHeight > 24800 && nHeight <= 28250 ) {
	        nSubsidy = 100 * COIN;
	}else if( nHeight > 28250 && nHeight <= 32400 ) {
	        nSubsidy = 150 * COIN;
	}else if( nHeight > 32400 && nHeight <= 71600 ) {
	        nSubsidy = 200 * COIN;
	} else {
		nSubsidy = 100 * COIN;
	}
