                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Chronon-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Chronon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chronon: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Chronon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Chronon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Chronon"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Chronon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Chronon addresses"));
    ...
    openAction->setStatusTip(tr("Open a Chronon: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Chronon Core help message to get a list with possible Chronon command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Chronon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Chronon network", "", count));
}
...
{
    QString strTitle = tr("Chronon Core"); // default title
