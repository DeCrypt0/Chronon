...
/** Utility functions used by the CHN Qt UI.
 */
namespace GUIUtil
{
...
// Render CHN addresses in monospace font
...
// Parse "chronon:" URI into recipient object, return true on successful parsing
