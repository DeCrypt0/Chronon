...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Chronon server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CHN features */
        {"chronon", "masternode", &masternode, true, true, false},
        {"chronon", "masternodelist", &masternodelist, true, true, false},
        {"chronon", "mnbudget", &mnbudget, true, true, false},
        {"chronon", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"chronon", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"chronon", "mnsync", &mnsync, true, true, false},
        {"chronon", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"chronon", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use chronond, or the -server option to chronon-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Chronon Alert\" admin@foo.com\n"),
...
{
    return "> chronon-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15289/\n";
}
